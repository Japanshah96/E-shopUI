...
class Favourites extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Controller favController = Get.put(Controller(), permanent: false);

    // FavouritesController addtocartController =
    //     Get.put(FavouritesController(), permanent: false);

    FavouritesController addfavController =
        Get.put(FavouritesController(), permanent: false);
    return Scaffold(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: ListView.separated(
                            ...
                            shrinkWrap: true,
                            itemCount: addfavController.number.length,
                                ...
                                child: Slidable(
                                  ...
                                  endActionPane: ActionPane(
                                      ...
                                      dismissible:
                                        ...
                                        addfavController.number.removeAt(index);
                                      }),
                                      children: [
                                        SlidableAction(
                                          // flex: 1,
                                          onPressed: (context) {
                                            addfavController.atc.add(
                                                addfavController.number[index]);
                                            print(addfavController.atc
                                                .toString());
                                          },
